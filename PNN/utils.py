...
features：
- Label - Target variable that indicates if an item was clicked (1) or not (0).
...
def create_criteo_dataset(file, embed_dim=8, read_part=True, sample_num=100000, test_size=0.2):
    ...
    feat_columns = [[denseFeature(feat) for feat in dense_features]] + \
    ...
    return feat_columns, (train_X, train_y), (test_X, test_y)